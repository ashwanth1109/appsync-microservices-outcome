package com.gql.microservices.orders;

import com.gql.microservices.orders.deploy.Runner;
...
public class Manager {
    ...
    public static void main(String[] args) {
        System.out.println("Running orders microservices manager with args:\n" + Arrays.toString(args));
