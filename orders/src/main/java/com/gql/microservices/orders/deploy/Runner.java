package com.gql.microservices.orders.deploy;

import com.gql.microservices.orders.Manager;
import com.gql.microservices.orders.deploy.stacks.MicroServiceStack;
...
public class Runner {
    ...
    public void synth() {
        App app = new App();
        String rootStack = Manager.withEnv("orders-micro-service-stack");
        new MicroServiceStack(app, rootStack);
